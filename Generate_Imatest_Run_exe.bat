...
::rem 设置 需要打包 脚本路径
set PYTHON_SCRIPT=UI\Imatest_Run.py
...
:: 安装依赖
REM ::设置目标文件夹路径
set DEST_FOLDER_DIST=dist\Imatest_Run
set DEST_FOLDER_BUILD=build\Imatest_Run
set DEST_FOLDER_INTERNAL=_internal
set FILE_NAME=Imatest_Run.spec
set EXE_NAME=Imatest_Run.exe
REM
...
::拷贝文件夹，文件到当前目录下
set SOURCE_DICT_EXE=dist\Imatest_Run\Imatest_Run.exe
set SOURCE_DICT_INTERNAL=dist\Imatest_Run\_internal
